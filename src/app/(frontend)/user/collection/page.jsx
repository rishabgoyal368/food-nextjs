...
function Product() {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <h3 className="text-2xl font-bold text-gray-800 mb-4">Food to Explore</h3>
            ...
            >
              ...
              <div className="px-4 py-2 bg-gray-100 flex items-center justify-between">
                ...
                {showCartButton === true && activeProductId === product._id ? (
                  ...
                  <Button
                    className="bg-white text-green hover:bg-green"
                    onClick={() => hanldeShowCartButton(product._id)}
                  >
                    Add
                  </Button>
                )}
